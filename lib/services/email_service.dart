...
class EmailService {
  ...
  static const String _templateId = 'template_lqsep6t'; // Confirmação de inscrição
  static const String _templateCancelamentoId = 'template_c9d1cgz'; // Cancelamento de evento
